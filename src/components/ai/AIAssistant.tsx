...
export function AIAssistant({ currentPage, appointmentCount, pendingNotes, activePatients }: AIAssistantProps) {
  ...
  return (
    <>
      ...
      <button
        onClick={() => setOpen(o => !o)}
        className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-white hover:bg-gray-50 text-teal-600 shadow-lg border border-gray-200 flex items-center justify-center transition-all"
